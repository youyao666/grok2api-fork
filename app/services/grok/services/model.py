...
class ModelService:
    ...
    MODELS = [
        ...
        ModelInfo(
            ...
            tier=Tier.BASIC,
            cost=Cost.HIGH,
            display_name="Imagine X-1",
            description="Primary image generation model routed through the websocket image feed",
            is_image=True,
            is_image_edit=False,
            is_video=False,
        ),
        ...
        ModelInfo(
            ...
            cost=Cost.HIGH,
            display_name="Grok Video",
            description="Alias for the video generation model",
            is_image=False,
            is_image_edit=False,
            is_video=True,
        ),
